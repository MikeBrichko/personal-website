              ...
              <div className="container-title text-center mb-4 pb-2">
                <div className="titles">
                  ...
                  <p className="pera-title para-desc-600 text-light-muted mb-0 mx-auto">
                    Obviously Im a Web Designer. Experienced with all stages of the development
              ...
              <div className="contact-detail text-center">
                <div className="icon">
                  <svg
                    ...
                    className="feather feather-phone fea icon-md">
              ...
              <div className="contact-detail text-center">
                <div className="icon">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="feather feather-mail fea icon-md">
              ...
              <div className="contact-detail text-center">
                <div className="icon">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="feather feather-map-pin fea icon-md">
                ...
                <div className="content mt-4">
                  ...
                  <a
                    ...
                    className="map-popup-view text-primary">
                    View on Google map
                  </a>
                </div>
              </div>
